...
import com.fc.nit.wallet.erc20.service.Erc20TraceService;
 ...
 */
@Controller
@RequestMapping("/nit/erc20trace")
public class Erc20TraceController {

	Logger logger = Logger.getLogger(Erc20TraceController.class);
	...
	@Autowired
	Erc20TraceService fcNitTraceService;
	...
	public String initiateTrade(String ownAddress,String toAddress,String password,String privateKey,String amount) {
		...
		try {
			req = fcNitTraceService.erc20InitiateTrade(ownAddress,toAddress, password, privateKey, amount);
